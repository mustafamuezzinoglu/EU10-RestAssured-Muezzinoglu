...
//save baseUrl inside this variable so that we dont need to type each http method
   ...
   */
    ...
    public void test1() {
        ...
        //verify Blythe is in the json payload(body)
    ...
    @Test
    public void test3() {
        Response response = given().log().all() // to see whats happening in test part add log and all
                .accept(ContentType.JSON)
                .and()
    ...
    @Test
    public void test4() {
        // create a map anbd add query parameters
        Map<String, Object> queryMap = new HashMap<>();
        queryMap.put("nameContains", "e");
        queryMap.put("gender", "Female");

        Response response = given()
                .log().all() // to see whats happening in test part add log and all
                .accept(ContentType.JSON)
                .and()
